...
### **trait selection**
Our method recomments users to select target and auxiliary traits with heritability z-score > 6, and include auxiliary traits with r_g^2 < 0.5 with the target trait. Our software will automatically remove auxiliary traits with r_g^2 > 0.5 during computation. 
