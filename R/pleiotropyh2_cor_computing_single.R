...
#' "427.2","454.1","278.1","250.2","550.1",
#' "530.11","296.22","519.8","562.1","763")
#'
#' post_corrrresults<-pleiotropyh2_cor_computing_single(G,phenotype,h2_vector_15D,
#' h2_vector_mat_15D,Results_full_rg_15D,Results_full_rg_array_15D, sample_rep = 10,
#' tolerance = 1e-6,seed = 123)
#'
pleiotropyh2_cor_computing_single<-function(G,phenotype,h2_vector,h2_vector_mat,Results_full_rg,Results_full_rg_array, sample_rep = 1000, tolerance = 1e-6,seed = 123){
  ...
  Results_collection_category$h2pleio<-h2pleiotropy_sample_sum_allgenome
  Results_collection_category$h2pleio_se<-h2pleiotropy_jkse
  Results_collection_category$percentage_h2pleio<-h2pleiotropy_sum_percentage_allgenome
  Results_collection_category$percentage_h2pleio_se<-h2pleiotropy_percentage_jkse
  Results_collection_category$percentage_h2pleio_jackknife<-h2pleiotropy_sum_percentage
  ...
  Results_collection_category$h2pleio_corr_se<-Results_collection_category$h2pleio_se*true_pleio_h2_correct/Results_collection_category$h2pleio
  Results_collection_category$percentage_h2pleio_corr<-true_pleio_h2_correct_percentage
  Results_collection_category$percentage_h2pleio_corr_se<-Results_collection_category$percentage_h2pleio_se*true_pleio_h2_correct_percentage/Results_collection_category$percentage_h2pleio
