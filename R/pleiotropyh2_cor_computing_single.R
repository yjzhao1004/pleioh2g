...
#' pleiotropyh2_cor_computing_single(G,phenotype_path,save_path,h2_vector_15D,
#' h2_vector_mat_15D,Results_full_rg_15D,Results_full_rg_array_15D, sample_rep = 10,
#' tolerance = 1e-6,seed = 123)
#'
pleiotropyh2_cor_computing_single<-function(G,phenotype_path,save_path,h2_vector,h2_vector_mat,Results_full_rg,Results_full_rg_array, sample_rep = 1000, tolerance = 1e-6,seed = 123){
