...
#' tolerance <- 1e-6
#' seed <- 123
#' pleiotropyh2_singlecategory_all(G,phenotype_path,save_path,h2_vector_45D,h2_vector_mat_45D,Results_full_rg_45D,
#' Results_full_rg_array_45D,Rg_mat_z_45D,sample_rep,tolerance,seed)

pleiotropyh2_singlecategory_all<-function(G,phenotype_path,save_path,h2_vector,h2_vector_mat,Results_full_rg,Results_full_rg_array,Rg_mat_z,sample_rep,tolerance,seed){
  ...
  for(C in c(1:length(unique_category))){
    currentcategory<-unique_category[C]
