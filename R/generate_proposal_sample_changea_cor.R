...
#' ratio_a <- 0.75
#' seed=123
#' generate_proposal_sample_changea_cor(Results_full_rg_15D, Results_full_rg_array_15D, plei_h2_idx, ratio_a,seed)

generate_proposal_sample_changea_cor <- function(Results_full_rg, Results_full_rg_array, plei_h2_idx, ratio_a,seed) {
  set.seed(seed)
