...
pleiotropyh2_cor_computing_single_prune<-function(G,phenotype,h2_vector,h2_vector_mat,Results_full_rg,Results_full_rg_array, sample_rep = 1000, tolerance = 1e-6,seed = 123){
  ...
  Results_collection_category$h2pleio_corr_se<-Results_collection_category$h2pleio_se*true_pleio_h2_correct/Results_collection_category$h2pleio_uncorr
  Results_collection_category$percentage_h2pleio_corr<-true_pleio_h2_correct_percentage
  Results_collection_category$percentage_h2pleio_corr_se<-Results_collection_category$percentage_h2pleio_se*true_pleio_h2_correct_percentage/Results_collection_category$percentage_h2pleio_uncorr
