...
#' package = "pleioh2g")
#' pleiotropyh2_D_othersall(G,phenotype_path,save_path,allauxD_results_path,h2_vector_45D,h2_vector_mat_45D,Results_full_rg_45D,
#' Results_full_rg_array_45D,Rg_mat_z_45D,sample_rep,tolerance,seed)

pleiotropyh2_D_othersall<-function(G,phenotype_path,save_path,allauxD_results_path,h2_vector,h2_vector_mat,Results_full_rg,Results_full_rg_array,Rg_mat_z,sample_rep,tolerance,seed){
